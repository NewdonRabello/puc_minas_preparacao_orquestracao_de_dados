...
df = spark.read.csv(
    "s3://newdonrabello-134769440578/titanic",
    header=True, schema=schema, sep=";"
)

print("Writing titanic dataset as a delta table...")
df.write.format("delta").mode("overwrite").save("s3://newdonrabello-134769440578/silver/")
...
old = DeltaTable.forPath(spark, "s3://newdonrabello-134769440578/silver/")
